...
public class SideConfigurationPanel extends JTabbedPane {
	...
	public static void main(final String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					SideConfigurationPanel panel = new SideConfigurationPanel();
	...
	public SideConfigurationPanel() {
		...
		TrainStrategyPanel trainingsPanel = new TrainStrategyPanel();
		...
		StandardOptionsPanel standardOptionsPanel = new StandardOptionsPanel();
		...
		SelectedSymbolPanel selectedSymbolPanel = new SelectedSymbolPanel();
