...
public enum Actions {
	...
	// Actions
	CREATE_NETWORK, TRAIN_NETWORK, CHANGE_MOUSE_MODI, UPDATE_SIDEBAR_CONFIG_INPUT_BIAS_MODEL, UPDATE_SIDEBAR_CONFIG_HIDDEN_BIAS_MODEL, UPDATE_JUNG_GRAPH_INPUT_BIAS, UPDATE_JUNG_GRAPH_HIDDEN_BIAS, SET_THE_STRATEGY,

	// SOM Actions
	UPDATE_SIDEBAR_TOPOLOGYSOM_VIEW, UPDATE_SIDEBAR_TRAINSTRATEGY_LERNRATE_MODEL,

	// Load Example-Networks
	LOAD_OR_NETWORK, LOAD_XOR_NETWORK, LOAD_AND_NETWORK, LOAD_2_BIT_ADDIERER_NETWORK, UNDO, REDO, CHANGE_BETWEEN_SESSIONS;
}
