...
private int inputSize;
  ...
  public DynamicBeanCreator(int inputSize, int outputSize) {
    ...
    _cg = new ClassGen(className, "java.lang.Object", className+"java", ACC_PUBLIC | ACC_SUPER, new String[] { interfaceName });
  ...
  private void createToString() {
	    ...
	    InstructionHandle ih_57 = il.append(_factory.createLoad(Type.OBJECT, 2));
	    il.append(new PUSH(_cp, " --> "));
	    il.append(_factory.createInvoke("java.lang.StringBuilder", "append", new ObjectType("java.lang.StringBuilder"), new Type[] { Type.STRING }, Constants.INVOKEVIRTUAL));
	    il.append(InstructionConstants.POP);
	    InstructionHandle ih_64 = il.append(new PUSH(_cp, 0));
	    il.append(_factory.createStore(Type.INT, 3));
	    ...
	    InstructionHandle ih_69 = il.append(_factory.createLoad(Type.OBJECT, 2));
	    il.append(_factory.createLoad(Type.OBJECT, 1));
	    il.append(_factory.createLoad(Type.OBJECT, 0));
	    il.append(_factory.createFieldAccess(className, "output", new ArrayType(new ObjectType("java.lang.Double"), 1), Constants.GETFIELD));
	    il.append(_factory.createLoad(Type.INT, 3));
	    ...
	    il.append(_factory.createInvoke("java.lang.StringBuilder", "append", new ObjectType("java.lang.StringBuilder"), new Type[] { Type.STRING }, Constants.INVOKEVIRTUAL));
	    il.append(InstructionConstants.POP);
	    InstructionHandle ih_91 = il.append(new IINC(3, 1));
	    InstructionHandle ih_94 = il.append(_factory.createLoad(Type.INT, 3));
	    il.append(_factory.createLoad(Type.OBJECT, 0));
	    il.append(_factory.createFieldAccess(className, "output", new ArrayType(new ObjectType("java.lang.Double"), 1), Constants.GETFIELD));
	    il.append(InstructionConstants.ARRAYLENGTH);
	        BranchInstruction if_icmplt_100 = _factory.createBranchInstruction(Constants.IF_ICMPLT, ih_69);
	    il.append(if_icmplt_100);
	    InstructionHandle ih_103 = il.append(_factory.createLoad(Type.OBJECT, 2));
	    il.append(new PUSH(_cp, "\n"));
	    il.append(_factory.createInvoke("java.lang.StringBuilder", "append", new ObjectType("java.lang.StringBuilder"), new Type[] { Type.STRING }, Constants.INVOKEVIRTUAL));
	    il.append(InstructionConstants.POP);
	    InstructionHandle ih_110 = il.append(_factory.createLoad(Type.OBJECT, 2));
	    il.append(_factory.createInvoke("java.lang.StringBuilder", "toString", Type.STRING, Type.NO_ARGS, Constants.INVOKEVIRTUAL));
	    InstructionHandle ih_114 = il.append(_factory.createReturn(Type.OBJECT));
	    goto_20.setTarget(ih_48);
	    goto_66.setTarget(ih_94);
	    method.setMaxStack();
	    method.setMaxLocals();
	    _cg.addMethod(method.getMethod());
	    il.dispose();
